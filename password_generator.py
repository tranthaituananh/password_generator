...
length = input("Hey, Welcome. Enter the number of characters you want to use for the password (default 128): ")
...
#Print the result
print ("Your random password of length is %s including" % length, lower,"lowercase,",upper,"uppercase,",number,"numbers and",symbol,"symbol characters\n")
